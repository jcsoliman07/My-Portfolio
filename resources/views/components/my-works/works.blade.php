    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <x-design-card
                    image="{{ asset('images/FRAMES/FRAME_HUMSS_2025.webp') }}"
                    alt="Facebook Frames"
                ...
                <x-design-card
                    image="{{ asset('images/POSTERS/2025_CHEERDANCE_POSTER_LEFT_SIDE.webp') }}"
                ...
                <!-- Facebook Poster CDLB Sportsfest -->
                <x-design-card
                    image="{{ asset('images/BACKDROP/BACKDROP 1.webp') }}"
